...
const SessionStatsPage: React.FC = () => {
  ...
  // Charger la liste des sessions (ou sessions actives)
  useEffect(() => {
  ...
  if (loading) {
    return <Typography>Chargement des sessions...</Typography>;
  }
  if (error) {
  ...
  return (
    <Box className="p-8 space-y-12">
        ...
        {/* Section des cartes */}
            <div className="grid grid-cols-4 md:grid-cols-1 gap-9">
