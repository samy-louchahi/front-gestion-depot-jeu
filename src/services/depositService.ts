 ...
 * Maintenant, pour chaque jeu, on attend un objet exemplaires (dictionnaire)
 */
...
/**
 * Créer un jeu déposé.
 * Le paramètre depositGameData doit inclure le champ exemplaires (dictionnaire)
 */
 ...
 * Le paramètre depositGameData doit inclure éventuellement la propriété exemplaires.
 */
